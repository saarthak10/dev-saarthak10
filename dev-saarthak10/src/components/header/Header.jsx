...
import menuDarkIcon from "../../assets/menu_dark_icon.svg";
import closeIcon from "../../assets/close_icon.svg";
import closeDarkIcon from "../../assets/close_dark_icon.svg";
  ...
  return (
    <div class="flex mx-auto max-w-7xl justify-between items-center  py-4 px-8 ">
      ...
      <div class={`md:hidden ${isOpen ? "hidden" : "block"}`}>
        <img src={theme === 'dark'? menuDarkIcon :menuIcon} onClick={() => setIsOpen(!isOpen)} />
      </div>
      ...
      {isOpen ? (
        <div class=" fixed  top-0 right-0 bottom-0 w-full bg-white dark:bg-gray-900 z-50 md:hidden transition-all duration-300 ">
          <div class="flex justify-between pl-4 pt-4 pb-5">
            ...
            <img src={theme === 'dark'?closeDarkIcon : closeIcon} class="pr-4" onClick={() => setIsOpen(!isOpen)} />
          </div>
          ...
          <div class="flex flex-col items-start gap-4">
            ...
            <div class="flex justify-between px-4 py-4 w-full items-center">
              ...
              <div class="px-4 py-4 w-full">
                  <button class="bg-black dark:bg-white w-full dark:text-black text-white rounded-lg p-3 text-xs ">
                    {" "}
                    Download CV
                  </button>
               </div>
